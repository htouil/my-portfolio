  ...
  return (
    <div id="projects" className="py-10 md:py-14">
      <div className="m-4 flex flex-col gap-7 rounded-xl bg-slate-950/60 px-3 py-5 min[500px]:p-5 sm:p-6 md:gap-10 lg:mx-10 lg:px-12 xl:mx-16 xl:px-14 xl:py-10">
        ...
        <div className="grid grid-cols-2 grid-rows-3 place-items-center max-[500px]:gap-x-4.5 gap-x-8 gap-y-6 md:gap-y-8 lg:gap-x-14 lg:gap-y-10 xl:px-10 2xl:gap-x-32 2xl:gap-y-16">
          <SingleProject
            title="so_long"
